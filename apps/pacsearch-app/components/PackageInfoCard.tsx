    ...
    return (
        <Card className="w-full max-w-5xl bg-slate-900 text-slate-100">
            <CardHeader>
                ...
                <p className="mt-2 text-slate-300">{props.description}</p>
            </CardHeader>
            <CardContent className="grid gap-4">
                ...
                <Separator className="bg-slate-700" />
                <InfoItem label="SHA256 Sum" value={props.sha256_sum} />
                <InfoItem label="PGP Signature" value={props.pgp_signature} className="truncate" />
            </CardContent>
        </Card>
    );
}
